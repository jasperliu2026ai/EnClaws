...
export const de: TranslationMap = {
  ...
  onboarding: {
    ...
    channelDesc: "Wählen Sie die Messaging-Plattform Ihres Teams, damit Ihr KI-Mitarbeiter Nachrichten empfangen und beantworten kann.",
    ...
    modelDesc: "Wählen Sie einen KI-Modellanbieter und geben Sie Ihren API-Schlüssel ein. Dies betreibt Ihren KI-Mitarbeiter.",
    ...
    doneDesc: "Ihr Agent ist bereit. Betreten Sie die Konsole, um Konfigurationen anzuzeigen und anzupassen.",
    enterConsole: "Konsole öffnen",
    skipConfirmTitle: "Einrichtung überspringen?",
    skipConfirmDesc: "Sie können die Kanal-, Modell- und KI-Mitarbeiter-Einrichtung jederzeit später in der Konsole abschließen.",
