...
export const en: TranslationMap = {
  ...
  onboarding: {
    ...
    channelDesc: "Choose your team's messaging platform so your AI employee can receive and reply to messages.",
    ...
    modelDesc: "Choose an AI model provider and enter your API Key. This powers your AI employee.",
    ...
    doneDesc: "Your Agent is ready. Enter the console to view and adjust configurations.",
    enterConsole: "Enter Console",
    skipConfirmTitle: "Skip setup?",
    skipConfirmDesc: "You can always complete the channel, model, and AI employee setup later in the console.",
