...
export const zh_CN: TranslationMap = {
  ...
  onboarding: {
    ...
    saveFailed: "保存失败",
    channelTitle: "接入消息渠道",
    channelDesc: "选择你的团队使用的即时通讯平台，让 AI 员工能够接收和回复消息。",
    ...
    optional: "可选，稍后配置",
    modelTitle: "配置 AI 模型",
    modelDesc: "选择 AI 模型提供商并填入 API Key，这是 AI 员工工作的基础。",
    ...
    doneTitle: "配置完成！",
    doneDesc: "你的 Agent 已准备就绪，可以进入管理台查看和调整配置。",
    enterConsole: "进入管理台",
    skipConfirmTitle: "确定跳过配置？",
    skipConfirmDesc: "跳过后你可以随时在管理台中手动完成渠道、模型和 AI 员工的配置。",
    continueSetup: "继续配置",
    confirmSkip: "跳过",
    channels: {
      feishu: "飞书",
  ...
  tenantChannels: {
    ...
    channelUpdated: "频道及关联代理已更新",
    channelCreated: "频道 {name} 及关联代理已创建",
    ...
    groupPolicy: "群组策略",
    agentConfig: "代理配置",
    agentDisplayName: "代理显示名称",
    agentDisplayNamePlaceholder: "输入代理名称",
    agentId: "代理 ID",
    agentIdPlaceholder: "输入代理ID",
    agentIdHint: "仅限小写英文、数字、连字符和下划线，由 Bot 名称自动生成",
    agentIdReadonly: "代理 ID 创建后不可修改",
    ...
    toolsHint: "默认允许全部工具。取消勾选可禁止代理使用该工具（硬约束，代理将无法调用）。",
    enableAll: "全部启用",
    disableAll: "全部禁用",
  ...
  login: {
    title: "登录 Enterprise Claw",
    titleRegister: "注册 Enterprise Claw",
    subtitle: "使用您的企业账号登录",
    ...
    registerFailed: "注册失败",
    noAccount: "还没有账号？",
    registerLink: "注册 Enterprise Claw",
    hasAccount: "已有账号？",
    backToLogin: "返回登录",
    tenantName: "企业名称",
