...
export const pt_BR: TranslationMap = {
  ...
  onboarding: {
    ...
    channelDesc: "Escolha a plataforma de mensagens da sua equipe para que seu funcionário de IA possa receber e responder mensagens.",
    ...
    modelDesc: "Escolha um provedor de modelo de IA e insira sua API Key. Isso alimenta seu funcionário de IA.",
    ...
    doneDesc: "Seu Agente está pronto. Entre no console para visualizar e ajustar as configurações.",
    enterConsole: "Entrar no Console",
    skipConfirmTitle: "Pular configuração?",
    skipConfirmDesc: "Você pode concluir a configuração do canal, modelo e funcionário de IA a qualquer momento no console.",
