...
# Output:
# - dist/EnClaws.app
# - dist/EnClaws-<version>.zip
# - dist/EnClaws-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.enclaws.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/EnClaws.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/EnClaws-$VERSION.zip"
DMG="$ROOT_DIR/dist/EnClaws-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/EnClaws-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/EnClaws-$VERSION.dSYM.zip"
