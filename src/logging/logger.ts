...
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "enclaws.log"); // legacy single-file path

const LOG_PREFIX = "enclaws";
...
function resolveSettings(): ResolvedSettings {
  ...
  const defaultLevel =
    process.env.VITEST === "true" && process.env.ENCLAWS_TEST_FILE_LOG !== "1" ? "silent" : "info";
