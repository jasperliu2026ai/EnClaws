...
export const DEFAULT_SANDBOX_IMAGE = "enclaws-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "enclaws-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "enclaws-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "enclaws-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "enclaws-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "enclaws-sandbox-browser";
